...
Click on *Databases* tab. Find the *MySQL* and click *Select*. 

image::images/mysql_template.png[image]
...
image::images/mysql_creation.png[image]
...
****
 oc label dc mysql app=pricelist --overwrite
****
...
****
Add to Project: consoleproject-UserName (this should be the same project as MySQL)
...
image::images/php_deployment_env.png[image]
...
image::images/php_confirm.png[image]
...
pricelist   pricelist-consoleproject-developer.192.168.42.123.nip.io             pricelist   8080-tcp                 None
....
